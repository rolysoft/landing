...
@NgModule({
  declarations: [ServicesComponent, FeaturesComponent, ClientsComponent, PlansComponent, FooterComponent, ScrollspyDirective, ModeloComponent],
  imports: [
    CommonModule, FeatherModule.pick(icons), CarouselModule, CountToModule
  ],
  exports: [ServicesComponent, FeaturesComponent, ClientsComponent, PlansComponent, FooterComponent, ScrollspyDirective, FeatherModule, ModeloComponent],
})
